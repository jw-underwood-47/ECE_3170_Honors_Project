...
/* THIS FILE IS A COPY OF SIM.C
 * THE ONLY DIFFERENCE IS THAT ALL ERRORS
 * SET THE AFFECTED BIT TO ZERO (REGARDLESS
 * OF WHAT IT WAS) AS THAT IS ALSO A REALISTIC
 * ERROR MODEL */
